...
@endif
    ...
    <p><label for="manufDate">Manufacture Date:</label> <input class="form-control" type="date" id="manufDate" name="manufDate" size="10" value="{{ $tube->manuf_date }}" placeholder="YYYY-MM-DD" ></p>
    <p><label for="installDate">Install date:</label> <input class="form-control" type="date" id="installDate" name="installDate" size="10" value="{{ $tube->install_date }}" placeholder="YYYY-MM-DD" ></p>
