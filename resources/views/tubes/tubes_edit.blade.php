    ...
    <form class="form-inline" action="{{route('tubes.update', $tube->id)}}" method="POST">
      ...
      <div class="row">
        <div class="col input-group mb-3">
          ...
          <input class="form-control" type="date" id="manufDate" name="manufDate" size="10" value="{{ substr($tube->manuf_date, 0, 10) }}" aria-label="Enter x-ray tube manufacture date">
        </div>
        <div class="col input-group mb-3">
          <span class="input-group-text">Install date:</span>
          <input class="form-control" type="date" id="installDate" name="installDate" size="10" value="{{ substr($tube->install_date, 0, 10) }}" aria-label="Enter x-ray tube install date">
        </div>
      </div>
      <div class="row">
        <div class="col input-group mb-3">
