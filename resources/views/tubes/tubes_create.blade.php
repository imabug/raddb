...
<form class="form-inline" action="{{ route('tubes.store') }}" method="POST">
	...
	<p><label for="lfs">Focal spot size: Large:</label> <input class="form-control" type="text" id="lfs" name="lfs" size="4" />mm
    	<label for="mfs">Medium:</label> <input class="form-control" type="text" id="mfs" name="mfs" size="4" >mm
		<label for="sfs">Small:</label> <input class="form-control" type="text" id="sfs" name="sfs" size="4" >mm</p>
