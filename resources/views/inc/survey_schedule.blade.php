    ...
    @foreach ($surveySchedule as $ss)
	  <tr>
        ...
        @if($ss->prevSurvey->hasMedia('survey_report'))
          <a href="{{ $ss->prevSurvey->getFirstMediaUrl('survey_report') }}" target="_blank" title="Survey report" alt="Survey report">
        ...
        @endif
          ...
          @if($ss->currSurvey->hasMedia('survey_report'))
            <a href="{{ $ss->currSurvey->getFirstMediaUrl('survey_report') }}" target="_blank" title="Survey report" alt="Survey report">
              <x-glyphs.file-earmark />
            </a></td>
          @endif
            @endif
