...
{{-- Used by the show() method in RecommendationController --}}
@extends('layouts.app')
    ...
    <form class="form-inline" action="{{ route('recommendations.update', $survey->id) }}" method="post" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col input-group mb-3">
          {{-- Table of existing recommendations is displayed by the RecommendationsForSurveyTable Laravel Livewire Tables component --}}
