...
<table class="table table-striped table-hover">
    ...
    @foreach ($manufacturer as $machine)
        <tr>
            <td>{{ $machine->id }}</td>
            <td><a href="/manufacturers/{{ $machine->manufacturer_id }}">{{ $machine->manufacturer->manufacturer }}</a></td>
            <td>{{ $machine->model }}</td>
            <td>{{ $machine->serial_number }}</td>
            <td><a href="/machines/{{ $machine->id }}">{{ $machine->description }}</a></td>
            <td><a href="/modalities/{{ $machine->modality_id }}">{{ $machine->modality->modality }}</a></td>
