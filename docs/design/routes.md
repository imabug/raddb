...
+--------+-----------+-----------------------------------------+------------------------------+--------------------------------------------------------------------------+-------------------------+
|        | GET|HEAD  | /                                       | dashboard.index              | RadDB\Http\Controllers\DashboardController@index                         | web                     |
...
|        | GET|HEAD  | manufacturers                           | showManufacturerIndex        | RadDB\Http\Controllers\ManufacturerController@showManufacturerIndex      | web                     |
|        | GET|HEAD  | manufacturers/{id}                      | showManufacturer             | RadDB\Http\Controllers\ManufacturerController@showManufacturer           | web                     |
|        | GET|HEAD  | modalities                              | showModalityIndex            | RadDB\Http\Controllers\ModalityController@showModalityIndex              | web                     |
|        | GET|HEAD  | modalities/{id}                         | showModality                 | RadDB\Http\Controllers\ModalityController@showModality                   | web                     |
...
|        | PUT       | surveys/storeReport                     | surveys.storeSurveyReport    | RadDB\Http\Controllers\TestDateController@storeSurveyReport              | web                     |
